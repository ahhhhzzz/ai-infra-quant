...
This is the task-branch schema over authoritative baseline `02326a3bb19c2a89352d765f5331670b5f3f466d`.
006B1/0004 is implemented pending independent review, not integrated.
...
| `0004_task006b1_market_archive` | Explicit immutable market captures, bar versions and memberships; task-branch head |
...
on the task branch, pending independent review; no earlier migration or ledger definition changes.
