"""Minimal R04 calendar certificate port; pinned lineage documented in the F1 guide."""

from datetime import UTC, date, datetime, time, timedelta
from itertools import pairwise
from zoneinfo import ZoneInfo

from ai_infra_quant.core.domain.paqs_q.canonical import utc
from ai_infra_quant.core.domain.paqs_q.inputs import Bar, Fact
